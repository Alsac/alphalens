...
# need pandas==0.20.2  python <=3.6  alphalens 0.3.6
import pandas as pd
import sys
sys.path.append(r'C:\Users\wangyl\Documents\GitHub\alphalens\alphalens_0_3_6\alphalens')
import alphalens
from alphalens.tears import (create_full_tear_sheet, create_event_returns_tear_sheet, create_information_tear_sheet, create_returns_tear_sheet)
