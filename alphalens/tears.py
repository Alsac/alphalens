...
#         returns_table.to_csv(os.path.join(save_path, 'returns_tables.csv'))
#
#     plotting.plot_quantile_returns_bar(
#         mean_quant_rateret,
#         by_group=False,
...
def create_full_tear_sheet(factor_data,
    ...
    if 3 in execute_num:
        create_turnover_tear_sheet(factor_data, set_context=False,turnover_periods=['1D','3D','5D','10D'], save_path=save_path)
